...
function getSonarQubeScannerExecutable(passExecutableCallback) {
  ...
  log(".npmrc setting: " + process.env.npm_config_sonar_scanner_version);
  log("Base value which is set: " + platformBinariesVersion);
  ...
  log(".npmrc value: " + process.env.npm_config_sonar_scanner_mirror);
